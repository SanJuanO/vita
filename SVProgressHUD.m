...
- (instancetype)initWithFrame:(CGRect)frame {
    if ((self = [super initWithFrame:frame])) {
        ...
        SVProgressHUDBackgroundColor = [self colorDesdeString:@"#F8F8F8" withAlpha:1.0];
        SVProgressHUDForegroundColor = [self colorDesdeString:@"#000000" withAlpha:1.0];
...
#else
    UIInterfaceOrientation orientation = CGRectGetWidth(self.frame) > CGRectGetHeight(self.frame) ? UIInterfaceOrientationPortrait : UIInterfaceOrientationPortrait;
#endif
